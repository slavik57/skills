...
var getUserOperation_1 = require('./getUserOperation');
...
describe('GetUsersOperation', function () {
    ...
    describe('execute', function () {
        describe('existing user', function () {
            ...
            beforeEach(function () {
                ...
                return createUserPromise.then(function () {
                    operation = new getUserOperation_1.GetUserOperation(user.attributes.username);
                });
            });
        ...
        describe('not existing user', function () {
            var operation;
            beforeEach(function () {
                operation = new getUserOperation_1.GetUserOperation('not existing user');
            });
...
//# sourceMappingURL=getUserOperation.test.js.map